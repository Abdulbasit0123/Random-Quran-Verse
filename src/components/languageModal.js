...
import { closeModal, searchInput, saveLanguageBtn, modalBackdrop, languageList } from '../dom';
import { updateLanguage } from '../utils/loadContent';

export let currentDirection = 'rtl';
...
// Click outside the modal content to close (optional, but good UX)
